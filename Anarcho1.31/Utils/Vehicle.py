...
class Vehicle:
    ...
    def initialize(self):
        traci.vehicle.setLaneChangeMode(self.ID,
                                        512)  # was 512, should it be 256? # Do we, sometimes, request a change, and it ignores it?
    ...
    def acc(self, spd, t):  # currently not used -> nothing depends on it in 1.3
        '''
