...
def run():
    ...
    startTestFlag = True
    TestSimFlag = False
    testDistRange = [60, 65, 70, 75, 80, 85, 90, 95]
    vehicles_list = [LH, RB]
    ...
    while traci.simulation.getMinExpectedNumber() > 0:
        ...
        if step ==2:
            ...
            #and LH.lane_pose<testDistRange[C+1]
            if LH.lane_pose >= testDistRange[C] and startTestFlag :
                traci.vehicle.moveTo(RB.ID,agent_lane_ID,0)
                TestSimFlag = True
                print("C: ",C)
                C+=1
            ...
            if TestSimFlag:
                ...
                if LH.lane_pose>100:
                    ...
                    traci.vehicle.moveTo(LH.ID,emer_lane_ID,0)
                    TestSimFlag = False
                    startTestFlag = True
