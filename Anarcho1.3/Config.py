...
vis_update_params['every_n_episodes'] = 100  # Print Episode info every_n_episodes
vis_update_params['every_n_iters'] = 2  # Print Iteration info every_n_iters inside single episode
...
q_learning_params['epsilon'] = 5.0  # Exploration rate
